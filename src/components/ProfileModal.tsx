...
import { User, Settings, LogOut, MessageCircle, Search, Brain, Camera, RefreshCw } from 'lucide-react';
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              <Button size="sm" variant="outline" className="absolute -bottom-1 -right-1 h-8 w-8 p-0 rounded-full bg-background border-2">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              return <Card key={index} className="bg-muted/30">
